// Exercise 2. Specify a horizontal offset via a uniform and move the triangle 
...
int main()
{
    ...
    const char *vertexShaderPath = "F:\\Projects\\LearnOpenGL\\shaders\\vertexShaderExercise2.vert";
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        set_shader_uniform_float(shader, "offset", 0.5f);
